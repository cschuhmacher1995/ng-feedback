/**
 * Advanced Angular Feedback
 * @version v0.0.1 - 2015-08-22 * @link https://github.com/jacobscarter/angular-feedback
 * @author Christian Schuhmacher
 * @license MIT License, http://www.opensource.org/licenses/MIT
 */
angular.module('templates-ngfeedback', ['ngfeedback.html']);

angular.module("ngfeedback.html", []).run(["$templateCache", function ($templateCache) {
    $templateCache.put("ngfeedback.html",
        "");
}]);

angular.module('ng-feedback', ['templates-ngfeedback', 'pascalprecht.translate'])
    ...
    .controller('FeedbackTemplateProviderController', ['$scope', function ($scope) {}])
                    ...
                    $.feedback = function (options) {
                        ...
                        var settings = $.extend({
                            ...
                            tpl: {
                                ...
                                //description:    '<div id="feedback-welcome"><div class="feedback-logo">{{"FEEDBACK_DESCRIPTION.FEEDBACK"|translate}}</div><p>Feedback lets you send us suggestions about our products. We welcome problem reports, feature ideas and general comments.</p><p>Start by writing a brief description:</p><textarea id="feedback-note-tmp"></textarea><p>Next we\'ll let you identify areas of the page related to your description.</p><button id="feedback-welcome-next" class="feedback-next-btn feedback-btn-gray">Next</button><div id="feedback-welcome-error">Please enter a description.</div><div class="feedback-wizard-close"></div></div>',
                                //highlighter:    '<div id="feedback-highlighter"><div class="feedback-logo">{{3+5}}</div><p>Click and drag on the page to help us better understand your feedback. You can move this dialog if it\'s in the way.</p><button class="feedback-sethighlight feedback-active"><div class="ico"></div><span>Highlight</span></button><label>Highlight areas relevant to your feedback.</label><button class="feedback-setblackout"><div class="ico"></div><span>Black out</span></button><label class="lower">Black out any personal information.</label><div class="feedback-buttons"><button id="feedback-highlighter-next" class="feedback-next-btn feedback-btn-gray">Next</button><button id="feedback-highlighter-back" class="feedback-back-btn feedback-btn-gray">Back</button></div><div class="feedback-wizard-close"></div></div>',
                                //overview: $templateCache.get('/templates/overview.html'),
                                //submitSuccess: $templateCache.get('/templates/submitSuccess.html'),
                                //submitError: $templateCache.get('/templates/submitError.html')
                            },
                            onClose: function () {
                            },
